        ...
        return l.jsxs(l.Fragment, {
          children: [l.jsxs("div", {
            ...
            children: [l.jsxs("div", {
              ...
              children: ft.map((P, ee) => {
                const de = B[`${yn}-${P.id}`] === U();
                return l.jsxs("button", {
                  ...
                  style: {
                    ...
                    gap: 10,
                    padding: "10px 12px",
                    background: de ? "#f0fdf4" : "#fff",
                    border: `1px solid ${de?"#22c55e20":`${v.l}30`}`,
                    borderRadius: 10,
                    cursor: "pointer",
                    textAlign: "right",
                    width: "100%",
